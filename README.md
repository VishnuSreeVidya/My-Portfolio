# Engineering Portfolio | Kotturu Vishnu Sree Vidya

A modern, responsive dark-themed developer portfolio showcasing clean software architecture, scalable backend structures, AI-driven threat intelligence, and decentralized protocols. Built with clean HTML5 semantic structures and fluid CSS layout mechanics.

🌐 **Live Application:** [https://vishnusreevidya.github.io/My-Portfolio/]

---

## 🎯 Professional Overview

Dynamic Computer Science student specializing in IoT, Cybersecurity, and Blockchain frameworks at Vasireddy Venkatadri International Technological University (CGPA: 9.1/10.0, Institutional Gold Medalist). Proficient in assembling full-stack environments with specialized experience in building secure backend pipelines, threat detection engines, cloud assets, and cryptographic decentralized protocols.

Driven by programmatic optimization, strict architecture patterns, and implementing systemic cryptographic and AI-driven security solutions from day one.
...
* **AI & Security:** Threat Detection, Log Analysis, Heuristic Scanners, SOC Telemetry, Scikit-learn, Pandas, AES-GCM-256, PBKDF2, JWT, Wireshark, Nmap, Metasploit, Autopsy
* **Full-Stack & Web:** Python (Flask), React.js, Node.js, Express.js, JavaScript, HTML5, CSS3, Tailwind CSS
* **Databases & Cloud:** PostgreSQL, Supabase, MongoDB, Oracle Database, MySQL
* **DevOps & Tools:** Git / GitHub, Docker, Docker Compose, VirtualBox, VMware, VS Code
...
### 2. CyberShield AI — Real-Time Cyber Security Log Analyzer & SOC Platform
Production-grade cybersecurity log analyzer and threat detection platform featuring an interactive Security Operations Center (SOC) dashboard. Features asynchronous `ThreadPoolExecutor` log processing, 7-rule attack detection (Brute Force, SQLi, XSS, Directory Traversal, Port Scanning, DoS), URL & hash threat intelligence, and automated forensic PDF/CSV/JSON report exports.
* **Tech Stack:** Python 3.13, Flask, PostgreSQL, Docker, Scikit-learn, Pandas, Chart.js, Matplotlib
* **Repository:** [CyberShield-AI](https://github.com/VishnuSreeVidya/CyberShield-AI)

### 3. NodeTalk — Secure Real-Time Messaging Platform
...
### 4. CryptPact — End-to-End Encrypted Messaging Application
...
### 5. SafeLink — IoT-Based Emergency Response Wearable
